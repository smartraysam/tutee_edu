...
class CreateSmLanguagePhrasesTable extends Migration
{
    ...
    public function up()
    {
        ...
        $d = [
            ...
            [1, 'pay', 'Pay', 'Pay', 'Pay', 'Pay'],
            [1, 'cvc', 'cvc', 'cvc', 'cvc', 'cvc'],
			...
			[18, 'textlocal', 'Textlocal', '', '', ''],
            [18, 'sms_template', 'Sms Template', '', '', ''],
            ...
            [18, 'virtual_class_meetting', 'Vitual Class/Meeting', '', '', ''],
            ...
            [18, 'textlocal', 'Textlocal', '', '', ''],
            [18, 'sms_template', 'Sms Template', '', '', ''],
            [18, 'liability', 'Liability', 'Liability', 'Liability', 'Liability'],
            [18, 'asset', 'Asset', 'Asset', 'Asset', 'Asset'],
            [18, 'label', 'Label', 'Label', 'Label', 'Label'],
            [18, 'bank_details', 'Bank Details', 'Bank Details', 'Bank Details', 'Bank Details'],
            [18, 'africatalking', 'Africatalking', 'Africatalking', 'Africatalking', 'Africatalking'],
            [18, 'africatalking_api_key', 'Africatalking API Key', 'Africatalking API Key', 'Africatalking API Key', 'Africatalking API Key'],
            [18, 'slip', 'Slip', 'Slip', '', ''],
            [18, 'result_not_publish_yet', 'Result Not Publish Yet', 'Result Not Publish Yet', 'Result Not Publish Yet', 'Result Not Publish Yet']
        ];
