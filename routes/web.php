...
Route::get('upload-video', 'UploadVideoController@index');
Route::post('save-upload-video', 'UploadVideoController@uploadVideo');
Route::post('upload', 'DependencyUploadController@uploadFile');
Route::post('upload-advanced', 'UploadController@upload');
Route::post('delete-video', 'UploadVideoController@deleteVideo');
Route::post('edit-video', 'UploadVideoController@editVideo');

Route::get('get-video', 'UploadVideoController@getVideo');
Route::post('add_student_watch', 'VideoWatchListController@addWatchList');

//

Route::get('add-teacher', 'SmTeacherController@createTeacher');
Route::post('save-teacher', 'SmTeacherController@saveTeacher');

Route::get('signup', 'StudentRegistrationController@create');
Route::post('student-register', 'StudentRegistrationController@store');

//quiz
Route::get('quiz', 'QuizController@index');
Route::post('save-quiz', 'QuizController@store');
Route::get('get-quiz', 'QuizController@show');
Route::post('edit-quiz', 'QuizController@edit');
Route::post('delete-quiz', 'QuizController@delete');

Route::get('grade', 'QuizGradesController@index');
Route::get('add-grade', 'QuizGradesController@create');
Route::post('save-grade', 'QuizGradesController@store');
Route::post('edit-grade', 'QuizGradesController@edit');
Route::post('delete-grade', 'QuizGradesController@delete');

Route::get('quiz-answer', 'QuizAnsController@QuizSubmit');