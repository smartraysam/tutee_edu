...
Route::group(['middleware' => ['XSS']], function () {
    ...
    Route::get('scho*ol/{school_id}/subject', ['as' => 'subject', 'uses' => 'SmApiController@saas_subject_index']);
...
Route::get('get-upload-video', 'UploadVideoController@getVideocontent');
Route::get('get-student-watchlist', 'VideoWatchListController@getStudentWatchlist');
Route::post('add-student-watch', 'VideoWatchListController@addWatchList');

//Zoom API
Route::get('/meetings', 'ZoomController@list');

// Create meeting room using topic, agenda, start_time.
Route::post('/meetings', 'ZoomController@create');
...
Route::any('student-login', 'StudentRegistrationController@login');

//quiz

Route::get('get-quiz', 'QuizController@getQuiz');
Route::post('save-quiz-answer', 'QuizAnsController@postQuizAns');
Route::get('get-result', 'QuizAnsController@getResult');