...
class SmExamController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            $exams_types = SmExamType::where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->where('active_status',1)->get();
    ...
    public function exam_reset()
    {
        try {
            ...
            $exam_mark_stores = SmMarkStore::where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->get();
            SmMarkStore::query()->truncate();
            $exam_results_stores = SmResultStore::where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            //dd($e->where('academic_id', YearCheck::getAcademicId())->getMessage(), $e->errorInfo);
            Toastr::error('Operation Failed', 'Failed');
            return redirect()->back();
        }
    }
    ...
    public function show($id)
    {
        try {
            ...
            $exam = SmExam::find($id);
            $classes = SmClass::where('active_status', 1)->where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->get();
            $subjects = SmAssignSubject::where('active_status', 1)->where('class_id', $exam->class_id)->where('section_id', $exam->section_id)->where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->get();
            $sections = SmClassSection::where('class_id', $exam->class_id)->where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->get();
            $exams = SmExam::where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->get();
    ...
    {
        try {
            $subjects = SmAssignSubject::where('class_id', $request->id)->where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->get();
