...
class SmHomeworkController extends Controller
{
    ...
    public function homeworkList(Request $request)
    {
        try {
            set_time_limit(900);
            $homeworkLists = SmHomework::where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();
    ...
    public function searchHomework(Request $request)
    {
        ...
        try {
            ...
            $homeworkLists = $homeworkLists->where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();
    ...
    public function saveHomeworkData(Request $request)
    {
        ...
        try {
            ...
            $students = SmStudent::where('class_id', $request->class_id)->where('section_id', $request->section_id)->where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();
    ...
    public function evaluationHomework(Request $request, $class_id, $section_id, $homework_id)
    {
        ...
        try {
            $homeworkDetails = SmHomework::where('class_id', '=', $class_id)->where('section_id', '=', $section_id)->where('id', '=', $homework_id)->where('academic_id', YearCheck::getAcademicId())->first();
            $students = SmStudent::where('class_id', '=', $class_id)->where('section_id', '=', $section_id)->where('active_status', 1)->where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();
    ...
    public function searchEvaluation(Request $request)
    {
        ...
        try {
            $homeworkLists = SmHomework::where('active_status', '=', '1')->where('subject_id', '=', $request->subject_id)->where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();
            $classes = SmClass::where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();
    ...
    public function viewEvaluationReport($homework_id)
    {
        ...
        try {
            $homeworkDetails = SmHomework::where('id', $homework_id)->where('academic_id', YearCheck::getAcademicId())->first();
            $homework_students = SmHomeworkStudent::where('homework_id', $homework_id)->where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();

            // foreach($students as $student){
            //   $allStudents[] = SmStudent::select('full_name', 'admission_no')->where('id', $student->student_id)->where('academic_id', YearCheck::getAcademicId())->first();
            // }
    ...
    public function homeworkEdit($id)
    {
        ...
        try {
            ...
            $classes = SmClass::where('active_status', '=', '1')->where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();
            $sections = SmClassSection::where('class_id', '=', $homeworkList->class_id)->where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();

            $subjects = SmAssignSubject::where('class_id', $homeworkList->class_id)->where('section_id', $homeworkList->section_id)->where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();
