...
class SmClassTimeController extends Controller
{
    ...
    {
        try {
            $class_times = SmClassTime::latest()->where('school_id', Auth::user()->school_id)->where('academic_id', YearCheck::getAcademicId())->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $class_time->academic_id = YearCheck::getAcademicId();
