...
class SmWeekendController extends Controller
{
    ...
    public function index(Request $request)
    {
        try{
            ...
            $weekends = SmWeekend::where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->get();
    ...
    public function store(Request $request)
    {
        ...
        $weekends_count = SmWeekend::where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->count();
            if ($weekends_count==7) {
        ...
        try{
            ...
            $weekend->academic_id = YearCheck::getAcademicId();
            $result = $weekend->save();
