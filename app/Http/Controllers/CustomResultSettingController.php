...
class CustomResultSettingController extends Controller
{
    ...
    public function index()
    {
        ...
        try {
            ...
            $custom_settings = DB::table('custom_result_settings as crs')
                ...
                ->where('crs.academic_id', YearCheck::getAcademicId())
    ...
    public function store(request $request)
    {
        ...
        try {
            ...
            if ($check_exist == '') {
                ...
                $custom_setting->academic_id = YearCheck::getAcademicId();
                $custom_setting->save();
            } else {
    ...
    public function meritListReport(Request $request)
    {
        ...
        try {
            ...
            $classes = SmClass::where('active_status', 1)->where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->get();
            $eligible_students       = SmStudent::where('class_id', $InputClassId)->where('section_id', $InputSectionId)->where('academic_id', YearCheck::getAcademicId())->where('active_status',1)->get();
    ...
    public function progressCardReport(Request $request)
    {
        ...
        try {
            ...
            $system_setting = $system_setting->session_id;
            $custom_result_setup = CustomResultSetting::where('academic_year', $system_setting)->first();
            $assign_subjects = SmAssignSubject::where('class_id', $class->id)->where('section_id', $section->id)->where('sm_assign_subjects.academic_id', YearCheck::getAcademicId())->join('sm_subjects', 'sm_subjects.id', '=', 'sm_assign_subjects.subject_id')->get();
