...
class SmLeaveDefineController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try{
            $leave_types = SmLeaveType::where('active_status', 1)->where('school_id',Auth::user()->school_id)->where('academic_id', YearCheck::getAcademicId())->get();
            $roles = InfixRole::where('active_status', '=', '1')->where('id', '!=', 1)/* ->where('id', '!=', 2) */->where('id', '!=', 3)->where('id', '!=', 10)->where(function ($q) {
                $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
            })->get();
            $leave_defines = SmLeaveDefine::where('active_status', 1)->where('school_id',Auth::user()->school_id)->where('academic_id', YearCheck::getAcademicId())->get();
    ...
    public function store(Request $request)
    {
        ...
        try{
            $leaves = SmLeaveDefine::where('role_id', $request->role)->where('type_id', $request->leave_type)->where('academic_id', YearCheck::getAcademicId())->first();
            ...
            if ($leaves == "") {
                ...
                $leave_define->academic_id = YearCheck::getAcademicId();
