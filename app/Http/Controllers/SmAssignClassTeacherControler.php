...
class SmAssignClassTeacherControler extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            $assign_class_teachers = SmAssignClassTeacher::where('active_status', 1)->where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $assign_class_teacher->academic_id = YearCheck::getAcademicId();
            ...
            foreach ($request->teacher as $teacher) {
                ...
                $class_teacher->academic_id = YearCheck::getAcademicId();
