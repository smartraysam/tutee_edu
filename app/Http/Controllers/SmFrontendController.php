        ...
        try {
            if (Schema::hasTable('users')) {
                ...
                if (count($testInstalled) < 1) {
                    ...
                    $contact_info1 = SmContactPage::first();
                    $per = [];
                    ...
                    if ($button_settings->website_btn == 0) {
                        ...
                        if ($button_settings->website_url == '') {
                            ...
                            if (SmGeneralSettings::isModule('Saas') == TRUE) {
                                ...
                                return view('frontEnd.home.light_home', compact('exams', 'classes', 'subjects', 'exams_types', 'sections', 'news', 'testimonial', 'notice_board', 'events', 'academics', 'links', 'homePage', 'per','contact_info1'));
                            }
