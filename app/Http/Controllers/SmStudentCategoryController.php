...
class SmStudentCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            $student_types = SmStudentCategory::where('school_id',Auth::user()->school_id)->where('academic_id', YearCheck::getAcademicId())->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $student_type->academic_id = YearCheck::getAcademicId();
