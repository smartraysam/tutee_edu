@php $page_title="Home - tutee"; @endphp
...
@section('main_content')
    ...
    <style type="text/css">
        ...
        @media (max-width: 575px) {
            ...
            .bbb {
                background-image:url({{'public/frontend/Images/BGHeader.png'}});
        ...
        .bbb {
            background-image:url({{'public/frontend/Images/BGHeader1.jpg'}});
            background-repeat: no-repeat;
            background-size: 100% 600px; height: auto;
        }
    </style>
...
{{--    <div class="container-fluid" style="background-image: url('public/frontend/Images/backgroundHeader.png')">--}}
{{--                 </div>--}}
<section class="container-fluid">
    <div class="banner-area bbb"
         {{--style="background-image:url({{'public/frontend/Images/BGHeader1.jpg'}});
                 background-repeat: no-repeat;
                 background-size: 100% 600px; height: auto;"--}}>
        ...
        <div class="banner-inner ">
            <div class="banner-content">
                ...
                <a href="#" class="btn btn-lg btn-light mt-2 mb-4 app">
                    <img class="img-fluid mr-2" alt="playicon" src="{{asset('public/frontend/Images/playicon.png')}}"/> GOOGLE PLAY
                </a>
                <div class="row">
                    <div class="col-lg-12 mt-20-lg mt-4">
                        <img src="{{asset('public/frontend/Images/dashboard_1.png')}}" class="img-fluid" alt="" style="width: 600px;height: 400px">
                    </div>
                </div>
            </div>
        </div>
        ...
        {{--  <section class="container">
            <div class="banner-inner">
                <img class="img-fluid" src="{{URL::to('public/frontend/Images/header_dashboard.png')}}"
                     alt="img_learning_dashboard" style="border-radius: 10px; width: 100%; height:auto;">
                </div>
        </section>--}}
    @endif
    ...
    <!--================ News Area =================-->
    <section class="news-area section-gap-top mt-3" style="background-image:url({{'public/frontend/Images/Untitled-1.png'}});
            background-repeat: no-repeat;
    ...
    @if(isset($per["Academics"]))
        <!--================ Academics Area =================-->
        <section class="academics-area" style="background-image:url({{'public/frontend/Images/Untitled-2.png'}});
                background-repeat: no-repeat;
                background-position: left;
                background-size: 150px 150px;
    ...
    <!--================ Events Area =================-->
    <section class="fact-area mt-5 mb-5 section-bubble1" style="background-image:url({{'public/frontend/Images/Untitled-1.png'}});
            background-repeat: no-repeat;
            background-position: left;
            background-size: 150px 150px;
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-7 mt-20-lg">
                    <img src="{{asset('public/frontend/Images/15842-min-1536x1024.jpg')}}" class="img-fluid" alt="">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container-fluid">
            ...
            <div class="card-deck">
                ...
                <div class="card mx-0 shadow-none" style="background-color:#3BB9FF;">
                    <div class="card-head text-center"><br>
                        {{--<img src="{{asset('public/frontend/Images/cal.jpg')}}" class="img-fluid" alt="">--}}
                ...
                <div class="card mx-0 shadow-none" style="background-color:#050ead;">
                    ...
                    <div class="card-body">
                        <form action="{{url('send-message')}}" class="row contact_form mt-20" method="post" id="contactForm" novalidate="novalidate">
                            @csrf
                            <div class="col-lg-12">
