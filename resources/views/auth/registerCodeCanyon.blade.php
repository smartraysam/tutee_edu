                ...
                <div class="col-sm-8 col-lg-10 col-xl-10 col-md-7">
                    ...
                    <div class="in_login_content">
                        ...
                        <div class="in_login_page_iner">
                            ...
                            <form method="POST" class="loginForm" action="{{ url('register') }}" id="infix_form">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="in_single_input">
                                            <input type="text" name="academic" id="school_name"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group input-group in_single_input">
                                            <input type="text" name="class" id="school_name" placeholder="Enter Class"
                                                value="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group input-group in_single_input">
                                            <input type="text" name="first_name" id="school_name"
                                                placeholder="student first Name" value="">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group input-group in_single_input">
                                            <input type="text" name="last_name" id="school_name"
                                                placeholder="student last Name" value="">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="no-gutters input-right-icon in_single_input">
                                            <div class="col">
                                                <div class="input-effect sm2_mb_20 md_mb_20">
                                                    <input class="primary-input mydob date read-only-input"
                                                        id="startDate" type="text" name="date_of_birth"
                                                        value="25/01/2021" autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group input-group in_single_input">
                                            <input type="text" name="student_mobile" id="student_mobile"
                                                placeholder="student Mobile" value="">
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group input-group in_single_input">
                                            <input type="email" name="student_email" id="student_email"
                                                placeholder="student email" value="">
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group input-group in_single_input">
                                            <input type="text" name="guardian_name" id="school_name"
                                                placeholder="Guardian Name" value="">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group input-group in_single_input">
                                            <input type="text" name="guardian_email" id="guardian_email"
                                                placeholder="Guardian Email" value="">
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group input-group in_single_input">
                                            <input type="text" name="guardian_mobile" id="guardian_mobile"
                                                placeholder="Guardian  Mobile" value="">
                                        </div>
                                        <div class="text-danger error-message invalid-select mb-10"
                                ...
                                <div class="row mt-20">
                                    <div class="col-lg-12">
                                        <div class="form-group input-group in_single_input">
                                            <input type="text" name="how_do_know_us" id="school_name"
                                                placeholder="How do you know us.?" value="">
                                        </div>
                                    </div>
                                </div>
                                <div class="in_login_button text-center">
                                    <button type="submit" class="in_btn primary-btn fix-gr-bg" id="btnsubmit">
