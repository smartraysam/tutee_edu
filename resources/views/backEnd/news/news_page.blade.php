            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @else
                        @if(in_array(497, App\GlobalVariable::GlobarModuleLinks()) || isset(Auth::user()->role_id == 1) )
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                @if(in_array(496, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                                                ...
                                                @endif
                                                @if(in_array(498, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                                                <a class="dropdown-item" href="{{url('edit-news/'.$value->id)}}">@lang('lang.edit')</a>
                                                @endif
                                                @if(in_array(499, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
