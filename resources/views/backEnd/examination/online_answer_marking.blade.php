                ...
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-30">@lang('lang.marking') @lang('lang.online_exam')</h3>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody>
                                <tr align="center">
                                    <td colspan="3">
                                        ...
                                        <h3><b>@lang('lang.subjects'): </b>{{@$take_online_exam->onlineExam!=""?@$take_online_exam->onlineExam->subject->subject_name:""}}</h3>
                                        <h3><b>@lang('lang.total_marks'): </b></h3>
                                        <h3><b>@lang('lang.exam_has_to_be_submitted_within'): </b>{{@$take_online_exam->onlineExam !=""?@$take_online_exam->onlineExam->date:""}} {{@$take_online_exam->onlineExam!=""?@$take_online_exam->onlineExam->end_time:""}}</h3>
                                    </td>
                                </tr>
                                <tr>
                                    <th>@lang('lang.question')</th>
                                    <th class="text-right">@lang('lang.marks')</th>
                                    <th class="text-right">@lang('lang.currect')</th>
                                </tr>
                                @php 
                                    $j=0;
                                    ...
                                    <td width="60%">
                                        ...
                                        <div class="d-flex radio-btn-flex mt-20">
                                            <div class="mr-30">
                                                ...
                                                <label for="true_{{@$question->question_bank_id}}">@lang('lang.true')</label>
                                            </div>
                                            <div class="mr-30">
                                                ...
                                                <label for="false_{{@$question->question_bank_id}}">@lang('lang.false')</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mt-20">
                                            ...
                                            @endphp
                                            <h4>[@lang('lang.currect_answer'): {{$currect_multiple}}]</h4>
                                            @elseif(@$question->questionBank->type == "T")
                                                <h4>[@lang('lang.currect_answer'): {{@$question->questionBank->trueFalse == "T"? 'True': 'False'}}]</h4>
                                            @else 
                                                <h4>[@lang('lang.currect_answer'): {{@$question->questionBank->suitable_words}}]</h4>
                                            @endif
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="3" class="text-center">
                                        <button class="primary-btn fix-gr-bg">
                                            ...
                                            @lang('lang.submit') @lang('lang.marks')
                                        </button>
                                    </td>
                                </tr>
                            </tbody>
