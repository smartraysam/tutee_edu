                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 mt-30-md">
                                    <select class="w-100 bb niceSelect form-control{{ $errors->has('exam') ? ' is-invalid' : '' }}" name="exam">
                                        <option data-display="Select Exam *" value="">@lang('lang.select') @lang('lang.exam') *</option>
...
<section class="mt-20">
    <div class="container-fluid p-0">
        <div class="row mt-40">
            ...
            <div class="col-lg-6">
                <a href="{{url('exam-schedule/print', [$exam_id, $class_id, $section_id])}}" class="primary-btn small fix-gr-bg pull-right" target="_blank"><i class="ti-printer"> </i> @lang('lang.print')</a>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <table class="display school-table school-table-style" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ @$exam_date != ""? App\SmGeneralSettings::DateConvater(@$exam_date):''}}</td>
                            @foreach($exam_periods as $exam_period)
                            @php
