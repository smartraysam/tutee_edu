                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="hidden" name="exam_setup_ids[]" value="{{@$part->id}}">
                                    ...
                                    <input class="primary-input marks_input" type="number" name="marks[{{@$student->id}}][{{@$part->id}}]" value="0" max="100">
                                    <input class="primary-input marks_input" type="hidden" name="exam_Sids[{{@$student->id}}][{{@$entry_form_count++}}]" value="0">
                                    <label>{{@$part->exam_title}} @lang('lang.mark')</label>
                            ...
                            <td>
                                <div class="input-effect">
                                    ...
                                    <label for="subject_{{@$student->id}}_{{@$student->admission_no}}">@lang('lang.yes')</label>
                                </div>
