                ...
                <table class="display school-table school-table-style" cellspacing="0" width="100%" >
                    <thead>
                        <tr>
                            ...
                            <th colspan="{{$number_of_exam_parts + 1}}"> {{$subjectNames->subject_name}}</th> 
                        ...
                        <tr>
                            ...
                            @endforeach
                            <th>@lang('teacher') @lang('remarks')</th>
                        </tr>
                    </thead>
                    <tbody>                        
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                    <input class="primary-input marks_input" type="number" step="any" max="{{@$part->exam_mark}}"
