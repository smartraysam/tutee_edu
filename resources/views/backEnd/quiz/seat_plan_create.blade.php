    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="{{route('seat_plan')}}">@lang('lang.seat_plan')</a>
                <a href="{{route('seat_plan_create')}}">@lang('lang.assign_students') </a>
            </div>
        </div>
    </div>
</section>
...
<section class="mt-40">
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-lg-6">
                <div class="main-title">
                    <h3 class="mb-30">@lang('lang.assign_exam_room')</h3>
                </div>
            </div>
                ...
                <table class="display school-table school-table-style" cellspacing="0" width="100%" id="assign_exam_room">
                    <thead>
                        <tr>
                            ...
                            <th width="15%">@lang('lang.start_time')</th>
                            <th width="15%">@lang('lang.end_time')</th>
                            <th width="15%">@lang('lang.room') @lang('lang.no')</th>
                            <th width="10%">@lang('lang.capacity')</th>
                            <th width="10%">@lang('lang.assign_students') @lang('lang.no').</th>
                            <th width="10%" class="text-right">@lang('lang.action')</th>
                        </tr>
                    </thead>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="input-effect">
                                            ...
                                            <label>@lang('lang.enter') @lang('lang.student') @lang('lang.no')<span></span> </label>
                                            <span class="focus-border"></span>
