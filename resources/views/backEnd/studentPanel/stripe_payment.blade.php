...
<div class="container-fluid">
    ...
    <form method="POST" class="" action="{{url('fees-payment-stripe-store')}}" id="subscription-payment" data-cc-on-file="false" data-stripe-publishable-key="{{ @$stripe_info->gateway_publisher_key }}" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-lg-12">
                                ...
                                <div class="row mt-20">                                              
                                    ...
                                    <div class="col-lg-4 mt-20">
                                        <div class="input-effect">
                                            ...
                                            <label>@lang('lang.expiration_month')  <span>*</span></label>
                                            <span class="focus-border"></span> 
                                        </div>
                                    ...
                                    <div class="col-lg-4 mt-20">
                                        <div class="input-effect">
                                            ...
                                            <label>@lang('lang.expiration_year')  <span>*</span></label>
                                            <span class="focus-border"></span> 
                                        </div>                            
                                    </div>
