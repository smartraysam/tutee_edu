...
<div class="col-lg-9 staff-details">
    ...
    <ul class="nav nav-tabs tabs_scroll_nav" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#staffDocuments" role="tab" data-toggle="tab">@lang('lang.documents')</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#staffTimeline" role="tab" data-toggle="tab">@lang('lang.timeline')</a>
        </li>
    ...
    <div class="white-box">
        ...
        <thead>
            <tr>
                ...
                <th width="15%">@lang('lang.net_salary')({{$currency}})</th>
...
{{$value->created_at != ""? App\SmGeneralSettings::DateConvater($value->created_at):''}}
                ...
                <td>
                    @if($value->payroll_status == 'P')
                    <a class="modalLink" data-modal-size="modal-lg" title="View Payslip Details" href="{{url('view-payslip', $value->id)}}"><button class="primary-btn small tr-bg"> @lang('lang.view') @lang('lang.payslip')</button></a>
                    @endif
                </td>
            </tr>
            @endforeach
...
{{$value->apply_date != ""? App\SmGeneralSettings::DateConvater($value->apply_date):''}}
                        ...
                        <td>
                            <a class="modalLink" data-modal-size="modal-md" title="View Leave Details" href="{{url('view-leave-details', $value->id)}}"><button class="primary-btn small tr-bg"> @lang('lang.view') </button></a>
                        </td>
                    </tr>
                    @endforeach
                    @else 
...
<div role="tabpanel" class="tab-pane fade" id="staffDocuments">
    <div class="white-box">
        ...
        cellspacing="0">
            <thead class="d-block">
                <tr class="d-flex">
                    <th class="col-8">@lang('lang.document') @lang('lang.title')</th>
            ...
            <tbody class="d-block">
                ...
                <tr class="d-flex">
                    <td class="col-8">@lang('lang.joining_letter')</td>
                    <td class="col-4">
                ...
                <tr class="d-flex">
                    <td class="col-8">@lang('lang.resume')</td>
                    <td class="col-4">
                ...
                <tr class="d-flex">
                    <td class="col-8">@lang('lang.other_documents')</td>
                    <td class="col-4">
