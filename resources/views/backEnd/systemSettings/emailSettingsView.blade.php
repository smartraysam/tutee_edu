...
<section class="admin-visitor-area">
    <div class="container-fluid p-0">
        ...
        @if(in_array(411, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                    ...
                    <div class="row justify-content-center mb-30">
                        <div class="col-lg-4">
                            <div class="input-effect">
                                ...
                                type="text" name="from_name" id="from_name" autocomplete="off" value="{{isset($editData)? @$editData->from_name : old('from_name')}}">
