        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @else
                            @if(in_array(457, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
            ...
            <div class="col-lg-9">
                <div class="row">
                    ...
                    <div class="col-lg-12 no-gutters col-xl-4">
                        <div class="main-title sm_mb_20 sm2_mb_20 md_mb_20 " >
                            <h3 class="mb-0"> @lang('lang.database_backup_list')</h3>
                        </div>
                    </div>
                    <div class="row">
                    <div class="col-lg-12 col-xl-12 text-right col-md-12 mb-20  md_mb_20 title_custom_margin">
                    ...
                    <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled Images @lang('lang.backup')">
                            <button class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;" type="button" >Images @lang('lang.backup')</button>
                          </span>
                              <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled Full Project @lang('lang.backup')">
                            <button class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;" type="button" >Full Project @lang('lang.backup')</button>
                          </span>
                          <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled Database @lang('lang.backup')">
                            <button class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;" type="button" >Database @lang('lang.backup')</button>
                          </span>
                    @else
                        @if(in_array(460, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                        ...
                        @endif 
                        @if(in_array(461, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                                <a href="{{url('get-backup-files/2')}}" class="primary-btn small fix-gr-bg  demo_view">
                                <span class="ti-arrow-circle-down pr-2"></span>
                                Full Project @lang('lang.backup')
                                </a>
                        @endif 
                        @if(in_array(462, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                ...
                <div class="row">
                    ...
                    <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled Delete">
                      <button class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;" type="button" disabled> <span class="pl ti-close"></span>  @lang('lang.delete')</button>
                                    ...
                                    @if(in_array(458, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                                    ...
                                    @endif
                                        ...
                                        @if(in_array(459, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
