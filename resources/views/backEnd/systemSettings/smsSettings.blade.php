        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <ul class="nav nav-tabs tab_column" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#msg91_settings" role="tab" data-toggle="tab">@lang('lang.msg91') @lang('lang.settings')</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#textlocal_settings" role="tab" data-toggle="tab">@lang('lang.textlocal') @lang('lang.settings')</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#africatalking_settings" role="tab" data-toggle="tab">@lang('lang.africatalking') @lang('lang.settings')</a>
                    </li>  
                </ul>
            ...
            @if(in_array(446, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
            ...
            <div role="tabpanel" class="tab-pane fade" id="msg91_settings"> 
                @if(in_array(447, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                ...
                <div class="white-box">  
                    ...
                    <!-- Start Exam Tab -->
            <div role="tabpanel" class="tab-pane fade" id="textlocal_settings">
            @if(in_array(446, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'update-textlocal-data', 'id' => 'textlocal_form']) }}
            @endif
                <div class="white-box">
                        <div class="">
            ...
            <div role="tabpanel" class="tab-pane fade" id="africatalking_settings">
            @if(in_array(446, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'update-africatalking-data', 'id' => 'textlocal_form']) }}
            @endif
                <div class="white-box">
                        <div class="">
