                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if(!empty($is_data->purchase_code)) <p class="text-success">Verified | Published on {{date("F jS, Y", strtotime(@$is_data->activated_date))}}</p> @else <p class="text-danger"> Not Verified @endif  </p>
                                    </td>
                                <td>
                                    @if(@$row->isDisabled() || empty($is_data->purchase_code))
                                        ...
                                        @else
                                            @if('RolePermission' != $row->getName() && 'TemplateSettings' != $row->getName() )
                                                <label class="switch">
                                                    ...
                                                    class="switch-input1" {{@$row->isDisabled() == true? '':'checked'}}>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control " name="envatouser"  required="required"  placeholder="Enter Your Envato User Name" value="{{old('envatouser')}}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="purchasecode">Envato Purchase Code:</label>
                                                    <input type="text" class="form-control" name="purchase_code" required="required" placeholder="Enter Your Envato Purchase Code" value="{{old('purchasecode')}}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="domain">Installation Path:</label>
