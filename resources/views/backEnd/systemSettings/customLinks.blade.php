                                 ...
                                 <div class="row">  
                                                ...
                                                <div class="col-lg-3 mt-40"> 
                                                    <div class="input-effect">
                                                        ...
                                                        <label>@lang('lang.title') 04 </label>
                                                        <span class="focus-border"></span>
                                                    </div> 
                                                </div> 
                                                ...
                                                {{-- <div class="col-lg-3 mt-60"> 
                                                    <div class="input-effect">
                                                        ...
                                                        <label>@lang('lang.facebook') @lang('lang.url') </label>
                                                        <span class="focus-border"></span>
                                                    </div> 
                                                </div>  
                                                ...
                                                <div class="col-lg-3 mt-60"> 
                                                    <div class="input-effect">
                                                        ...
                                                        <label>@lang('lang.twitter') @lang('lang.url') </label>
                                                        <span class="focus-border"></span>
                                                    </div> 
                                                </div>  
                                                <div class="col-lg-3 mt-60"> 
                                                    <div class="input-effect">
                                                        ...
                                                        <label>@lang('lang.dribbble') @lang('lang.url') </label>
                                                        <span class="focus-border"></span>
                                                    </div> 
                                                </div>  
                                                <div class="col-lg-3 mt-60"> 
                                                    <div class="input-effect">
                                                        ...
                                                        <label>@lang('lang.behance') @lang('lang.url') </label>
                                                        <span class="focus-border"></span>
                                                    </div> 
                                                </div>   --}}
