            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @if(isset($editData))
                            @if(in_array(450, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                        ...
                        @else
                        @if(in_array(450, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                            {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'weekend/', 'method' => 'post', 'enctype' => 'multipart/form-data', 'id' => 'weekendForm']) }}
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        @if(in_array(449, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
