...
<section class="admin-visitor-area up_st_admin_visitor">
    <div class="container-fluid p-0">
        @if(isset($editData))
            @if(in_array(441, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
            <div class="row">
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        @if(in_array(442, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                                            <a class="dropdown-item" href="{{url('holiday/'.$value->id.'/edit')}}">@lang('lang.edit')</a>
                                        @endif
                                        @if(in_array(443, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
