...
<div class="container"> 
        <table style="width:100%; border:0;"> 
                ...
                <tr>
                    ...
                    <td  style=" padding:10px; vertical-align:top;">
                         @php $marks_grade=DB::table('sm_marks_grades')->where('academic_id', App\YearCheck::getAcademicId())->get(); @endphp
                                                    @if(@$marks_grade)
                                        ...
                                        <table class="w-100 mt-30 mb-20 table table-bordered marklist"  style="width: 100%; table-layout: fixed">
                                            ...
                                            <tbody>
                                                @php $i=1; $subject_mark = []; $total_student_mark = 0; $total_student_mark_optional = 0; @endphp
                                                    ...
                                                    $student_detail=App\SmStudent::where('id','=',$row->student_id)->where('academic_id', App\YearCheck::getAcademicId())->first();
                                                            $optional_subject='';
                                                                   
                                                            $get_optional_subject=App\SmOptionalSubjectAssign::where('student_id','=',$student_detail->id)->where('session_id','=',$student_detail->session_id)->where('academic_id', App\YearCheck::getAcademicId())->first();
                                                      ...
                                                      <td> 
                                                            ...
                                                            if($row->result == 'F'){
                                                               ...
                                                               $c = 0;
                                                                ...
                                                                foreach ($subject_mark as $mark) {
                                                                    ...
                                                                    $grade_gpa = DB::table('sm_marks_grades')->where('percent_from','<=',$mark)->where('percent_upto','>=',$mark)->where('academic_id', App\YearCheck::getAcademicId())->where('academic_id', App\YearCheck::getAcademicId())->first();
                                                        ...
                                                        <td> 
                                                             ...
                                                             if($row->result == 'F'){
                                                                 ...
                                                                 $optional_grade_gpa = DB::table('sm_marks_grades')->where('percent_from','<=',$optional_subject_mark)->where('percent_upto','>=',$optional_subject_mark)->where('academic_id', App\YearCheck::getAcademicId())->first();
                                                                ...
                                                                $total_grade_point = 0;
                                                                 ...
                                                                 foreach ($subject_mark as $mark) {
                                                                     ...
                                                                     // echo $mark;
                                                                     $grade_gpa = DB::table('sm_marks_grades')->where('percent_from','<=',$mark)->where('percent_upto','>=',$mark)->where('academic_id', App\YearCheck::getAcademicId())->first();
                                                                     $total_grade_point = $total_grade_point + $grade_gpa->gpa;
                                                                 }
                                                         ...
                                                         <td> 
                                                                ...
                                                                if($row->result == 'F'){
                                                                    ...
                                                                    $optional_grade_gpa = DB::table('sm_marks_grades')->where('from','<=',$grade)->where('up','>=',$grade)->where('academic_id', App\YearCheck::getAcademicId())->first();
