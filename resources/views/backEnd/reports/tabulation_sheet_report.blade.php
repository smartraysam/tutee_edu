                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 pull-right mt-20">
                        ...
                        <div class="print_button pull-right">
                            {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'tabulation-sheet/print', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'search_student', 'target' => '_blank']) }}
                                                ...
                                                <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            ...
                                                            $mark_grade = App\SmMarksGrade::where([['from', '<=', $number], ['up', '>=', $number]])->where('academic_id', App\YearCheck::getAcademicId())->first();
                                                            @endphp
                                                            {{@$mark_grade->grade_name }}
                                                         @endif
                                                    </td>
