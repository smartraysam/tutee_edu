    ...
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-lg-4 no-gutters">
                <div class="main-title">
                    <h3 class="mb-30 mt-30">@lang('lang.class_report_for_class') {{$class->class_name}} {{$section != ""? 'section ('. $section->section_name.')': ''}}</h3>
                </div>
            </div>
        </div>
        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="single-meta">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                            <div class="name text-left">
                                                {{number_format($total_assign - $total_collection-$applied_discount, 2)}}<input type="hidden" id="total_assign" name="total_assign" value="{{$total_assign}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
