                                                ...
                                                <div class="row  mt-40 ">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        @php
                                                            ...
                                                            $exam_types = App\SmExamType::where('active_status', 1)->where('academic_id', App\YearCheck::getAcademicId())->get();
                                                            $classes = App\SmClass::where('active_status', 1)->where('academic_id', App\YearCheck::getAcademicId())->get();
                                                                ...
                                                                <td>
                                                                    @php
                                                                        if($totalSubjectFail > 0){
                                                                            ...
                                                                            $mark_grade = App\SmMarksGrade::where([['percent_from', '<=', $totalSumSub], ['percent_upto', '>=', $totalSumSub]])->where('academic_id', App\YearCheck::getAcademicId())->first();
                                                        ...
                                                        <td colspan="{{$colspan / 2 + 1}}" class="text-center">
                                                            @php
                                                                if($total_fail != 0){ 
                                                                    ...
                                                                    $average_grade = App\SmMarksGrade::where([['percent_from', '<=', $totalSumSub], ['percent_upto', '>=', $totalSumSub]])->where('academic_id', App\YearCheck::getAcademicId())->first();
