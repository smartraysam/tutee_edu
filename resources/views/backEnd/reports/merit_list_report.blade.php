                                                                ...
                                                                if($row->result == 'F'){
                                                                        echo 'F';
                                                                         ...
                                                                         if ($grade>5) {
                                                                            ...
                                                                            $optional_grade_gp = DB::table('sm_marks_grades')->where('from','<=',$grade)->where('up','>=',$grade)->where('academic_id', App\YearCheck::getAcademicId())->first();
                                                                        //    dd($optional_grade_gp);
                                                                            echo @$optional_grade_gp->grade_name;
                                                                         }
