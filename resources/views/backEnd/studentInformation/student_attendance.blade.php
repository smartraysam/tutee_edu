    ...
    <div class="container-fluid p-0">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 text_sm_right text_xs_left col-sm-6">
                    <a href="{{url('student-attendance-import')}}" class="primary-btn small fix-gr-bg pull-right mb-20"><span class="ti-plus pr-2"></span>Import Attendance</a>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-30">@lang('lang.student_attendance') | <small>@lang('lang.class'): {{$search_info['class_name']}}, @lang('lang.section'): {{$search_info['section_name']}}, @lang('lang.date'): {{App\SmGeneralSettings::DateConvater($search_info['date'])}}</small></h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
