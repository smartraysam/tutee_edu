    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="#">@lang('lang.student_attendance') @lang('lang.import')</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container-fluid p-0">
        <div class="row">
            ...
            <div class="offset-lg-3 col-lg-3 text-right mb-20">
                <a href="{{url('/public/backEnd/bulksample/student_attendance.xlsx')}}" >
        ...
        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'student-attendance-bulk-store',
