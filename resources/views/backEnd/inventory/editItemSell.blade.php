...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.edit') @lang('lang.sells') @lang('lang.details')</h1>
            <div class="bc-pages">
                <a href="{{url('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.inventory')</a>
                <a href="{{url('item-sell-list')}}">@lang('lang.item_sell') @lang('lang.list')</a>
                <a href="#">@lang('lang.edit') @lang('lang.sells') @lang('lang.details')</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="main-title">
                    <h3 class="mb-30">
                        @lang('lang.edit') @lang('lang.sells') @lang('lang.details')
                    </h3>
                </div>
