...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.item_sell')</h1>
            <div class="bc-pages">
                <a href="{{url('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="{{url('item-sell')}}">@lang('lang.item_sell')</a>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-lg-12">
                    <div class="main-title">
                        <h3 class="mb-30">@if(isset($editData))
                            ...
                            @endif
                            @lang('lang.sells') @lang('lang.details')
                        </h3>
                    </div>
                            ...
                            <div class="row">
                                 ...
                                 <div class="col-lg-12 mb-30">
                                    ...
                                    <div class="alert alert-danger" id="errorMessage1">
                                        ...
                                        <select class="niceSelect w-100 bb form-control{{ $errors->has('role_id') ? ' is-invalid' : '' }}" name="role_id" id="buyer_type">
                                            <option data-display="Sale To *" value="">@lang('lang.sale_to') *</option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 mb-30" id="select_student_div">
                                                <select class="w-100 bb niceSelect form-control{{ $errors->has('student') ? ' is-invalid' : '' }}" id="select_student" name="student">
                                                    <option data-display="Select Student *" value="">@lang('lang.select_student') *</option>
                                                </select>
                                    ...
                                    <div class="col-lg-12 mb-30" id="selectStaffsDiv">
                                        <select class="niceSelect w-100 bb form-control{{ $errors->has('staff_id') ? ' is-invalid' : '' }}" name="staff_id" id="selectStaffs">
                                            <option data-display="Name *" value="">@lang('lang.name') *</option>
                                ...
                                <div class="col-lg-12 mb-30">
                                    <div class="input-effect">
                                        ...
                                        <label>@lang('lang.reference') @lang('lang.none')</label>
                                ...
                                <div class="col-lg-12 no-gutters input-right-icon mb-30">
                                    <div class="col">
                                        <div class="input-effect">
                                            ...
                                            <label>@lang('lang.sell_date') <span></span> </label>
                                            <span class="focus-border"></span>
        ...
        <div class="col-lg-9">
          ...
          <div class="row">
            <div class="col-lg-4 no-gutters">
                <div class="main-title">
                    <h3 class="mb-30">@lang('lang.item_sale')</h3>
                </div>
            </div>
                 ...
                 <table class="table" id="productTable">
                  ...
                  <tbody>
                      <tr id="row1" class="0">
                        <td class="border-top-0">
                            ...
                            <td class="border-top-0">
                                <div class="input-effect">
                                    ...
                                    type="text" id="unit_price1" name="unit_price[]" onkeypress="return isNumberKey(event)" autocomplete="off" value="{{isset($editData)? $editData->unit_price : '' }}" onkeyup="getTotalByPrice(1)">
                            ...
                            <td class="border-top-0">
                                <div class="input-effect">
                                    ...
                                    type="text" id="quantity1" name="quantity[]" onkeypress="return isNumberKey(event)" autocomplete="off" onkeyup="getTotalInSell(1);" value="{{isset($editData)? $editData->quantity : '' }}">
                        ...
                        <tfoot>
                            <tr>
                             <th class="border-top-0" colspan="2">@lang('lang.total')</th>
        ...
        <div class="white-box">
            ...
            <div class="row">
              <div class="col-lg-2 mt-30-md">
                 <div class="col-lg-12">
                    <div class="input-effect">
                        <input type="checkbox" id="full_paid" onkeypress="return isNumberKey(event)" class="common-checkbox form-control{{ $errors->has('full_paid') ? ' is-invalid' : '' }}" name="full_paid" value="1">                    
            ...
            <div class="col-lg-3 mt-30-md">
             <div class="col-lg-12">
                <div class="input-effect">
                    <input class="primary-input" onkeypress="return isNumberKey(event)" type="number" value="0" name="totalPaid" id="totalPaid" onkeyup="paidAmount();">
