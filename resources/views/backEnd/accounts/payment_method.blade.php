...
<section class="admin-visitor-area up_st_admin_visitor">
    <div class="container-fluid p-0">
        @if(isset($payment_method))
         @if(in_array(153, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                @foreach($payment_methods as $payment_method)
                                 @if(App\SmGeneralSettings::isModule('RazorPay') == FALSE && $payment_method->method == "RazorPay")
                                 @else
                                <tr>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                               @if(in_array(154, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )

                                                <a class="dropdown-item" href="{{route('payment_method_edit', [@$payment_method->id])}}">@lang('lang.edit')</a>
                                                @endif
                                                @if(in_array(155, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
