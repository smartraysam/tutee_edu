                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($result_subject == 0)
                                            <span class="primary-btn small bg-success text-white border-0">@lang('lang.pass')</span>
                                        @else
                                            <span class="primary-btn small bg-danger text-white border-0">@lang('lang.fail')</span>
                                        @endif
                                    </td>
                                </tr>
                                @endforeach
