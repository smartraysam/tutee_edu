                            ...
                            <table id="table_ids" class="display school-table" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>@php
                                            $balance = App\SmStudent::totalFees($student->feesAssign) - App\SmStudent::totalDiscount($student->feesAssign, $student->id) - App\SmStudent::totalDeposit($student->feesAssign, $student->id);
