...
<html>
<head>
    <title>@lang('lang.fees_groups_details')</title>
    <style>
            ...
            <table class="display school-table school-table-style" style="width: 100%; table-layout: fixed">
                ...
                <tbody>
                    ...
                    <tr align="center">
                        ...
                        <td>
                            @if($fees_assigned->feesGroupMaster!="") {{$fees_assigned->feesGroupMaster->date != ""? App\SmGeneralSettings::DateConvater($fees_assigned->feesGroupMaster->date):''}}
