                ...
                <table class="display school-table school-table-style" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td> {{$discount_amount}}  ({{$currency}})</td>
                            <td>{{$fine}}  ({{$currency}})</td>
                            <td>{{$paid}}  ({{$currency}})</td>
                            <td>
                                @php 
...
{{$payment->payment_date != ""? App\SmGeneralSettings::DateConvater($payment->payment_date):''}}
                        ...
                        <tr>
                            ...
                            <td>@if(in_array($fees_discount->id, $applied_discount))
                                ...
                                @endphp
                                <a href="#" data-toggle="tooltip" data-placement="right" title="{{'Collected By: '.@$created_by->full_name}}">Discount of ({{$currency}}){{@$fees_discount->feesDiscount->amount}} </a>
                                
                                @else
                                @lang('lang.discount_of')  ({{$currency}}){{$fees_discount->feesDiscount !=""?$fees_discount->feesDiscount->amount:""}} @lang('lang.assigned')
                                @endif
                            </td>
