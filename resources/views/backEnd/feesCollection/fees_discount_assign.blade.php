    ...
    <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-lg-12">
                        ...
                        @endif
                    <div class="white-box">
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'fees-discount-assign-search', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'search_studentA']) }}
                            <div class="row">
                                        ...
                                        <td>
                                            ...
                                            @if ($check_yearly_apply=='')  
                                                        <select class="niceSelect w-100  form-control{{ $errors->has('fees_master_id') ? ' is-invalid' : '' }} select_fees_master" name="fees_master_id[]" id="fees_master{{$student->id}}">
                                                         ...
                                                         @endif
                                                    @else 
                                                    <select class="niceSelect w-100  form-control{{ $errors->has('fees_master_id') ? ' is-invalid' : '' }} select_fees_master" name="fees_master_id[]" id="fees_master{{$student->id}}" disabled>
                                                             <option data-display="@lang('lang.select') @lang('lang.fees_group') *" value="">@lang('lang.select') @lang('lang.fees_group') *</option>
                                                             @foreach($assigned_fees_groups[$student->id] as $key=> $fees_group)
                                                                         ...
                                                                         array_push($group_ids,$fees_group->group_id);
                                                                         @endphp
                                                                 <option value="{{$fees_group->group_id}}" {{$fees_group->group_id == $check_yearly_apply->fees_group_id? 'selected':''}}>{{$fees_group->name}} (Applied) </option>
                                                             @endforeach
                                                          </select>
                                                         @if ($errors->has('fees_master_id'))
                                                         <span class="invalid-feedback invalid-select" role="alert">
