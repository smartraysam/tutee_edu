                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                           ...
                                           @if($payment->slip != "")
                                            ...
                                            <a class="dropdown-item" href="{{url('bank-slip-view/'.showPicName(@$payment->slip))}}">
